<template>
    <div class="scanIp">
        <el-dialog :visible.sync="ifIPScan" width="48%" center :before-close="modalClose">
            <span slot="title"  class="dialog-title">
                <p>根据ip扫描</p>
            </span>
            <div class="diaContent">
                <div class="aimBox">
                    <div class="aimTitle">ip地址</div>
                    <div class="aimContent">
                        <label for="ip">ip地址范围:</label>
                        <input type="text" placeholder="10.0.26.*" id="ip">
                        <div class="explain">
                            <p>说明：</p>
                            <p>地址范围支持多个ip(段) (例如："192.168.1,*,192.168.[2,3].[1-5,15,25,35,45]")。</p>
                            <p>单个ip或ip (段)也可以写在一行里面</p>
                        </div>
                    </div>
                </div>
                <div class="aimCheck">
...
.scanIp .diaContent .aimBox,
.scanIp .diaContent .aimCheck{
    width:33%;
    height:100%;
    box-sizing: border-box;
...
.scanIp .diaContent .aimBox .aimTitle,
.scanIp .diaContent .aimCheck .checkTitle{
    width:100%;
    height:8%;
    background:#eee;
...
.scanIp .diaContent .aimCheck .checkLists,
.scanIp .diaContent .aimBox .aimContent{
    width:100%;
    height:92%;
    box-sizing: border-box;
    padding: 20px 10px;
}
.scanIp .diaContent .aimBox .aimContent>input{
    margin: 10px 0 20px;
    display: block;
    border: none;
    width: 100%;
...
.scanIp .diaContent .aimBox .aimContent .explain>p{
    line-height:25px;
}
</style>
